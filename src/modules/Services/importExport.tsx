  ...
  return (
    <div>
      <SectionBanner
        ...
        subTitle="Guranteed logistics to strengthen your market visiblity in West-African markets."
      />
          ...
          <div className="row">
            <div className="col-md-12">
              <h3 className={styles.title}>
                As a commission agency, we find the right fit <br /> for your
                product beyond borders
              </h3>
            </div>
          </div>
